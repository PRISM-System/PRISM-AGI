...
websocket_urlpatterns = [
    ...
    re_path(r'django/ws/chat/(?P<session_id>[\w\-_]+)/$', consumers.ChatConsumer.as_asgi()),
    re_path(r'django/ws/orchestrate/(?P<session_id>[\w\-_]+)/$', consumers.OrchestrateConsumer.as_asgi()),
]
